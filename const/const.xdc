...
set_property IODELAY_GROUP IO_DLY1 [get_cells idelayctrl_inst]
set_property IODELAY_GROUP IO_DLY1 [get_cells idelay0]
set_property IODELAY_GROUP IO_DLY1 [get_cells idelay1]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {test_shift[0]} {test_shift[1]} {test_shift[2]} {test_shift[3]} {test_shift[4]} {test_shift[5]} {test_shift[6]} {test_shift[7]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {E[0]} {E[1]} {E[2]} {E[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 8 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {test_100[0]} {test_100[1]} {test_100[2]} {test_100[3]} {test_100[4]} {test_100[5]} {test_100[6]} {test_100[7]}]]
set_property PACKAGE_PIN N20 [get_ports test_out]
set_property IOSTANDARD LVCMOS33 [get_ports test_out]
set_property SLEW FAST [get_ports test_out]
