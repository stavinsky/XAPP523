...
connect_debug_port u_ila_0/probe0 [get_nets [list {decoder/shift[0]} {decoder/shift[1]} {decoder/shift[2]} {decoder/shift[3]} {decoder/shift[4]} {decoder/shift[5]} {decoder/shift[6]} {decoder/shift[7]} {decoder/shift[8]} {decoder/shift[9]} {decoder/shift[10]} {decoder/shift[11]} {decoder/shift[12]} {decoder/shift[13]} {decoder/shift[14]} {decoder/shift[15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 8 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {decoder/decoded_byte[0]} {decoder/decoded_byte[1]} {decoder/decoded_byte[2]} {decoder/decoded_byte[3]} {decoder/decoded_byte[4]} {decoder/decoded_byte[5]} {decoder/decoded_byte[6]} {decoder/decoded_byte[7]}]]
create_debug_port u_ila_0 probe
