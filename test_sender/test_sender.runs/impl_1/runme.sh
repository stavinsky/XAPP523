...
HD_PWD='/home/dev/dev/fpga/projects/manchester/test_sender/test_sender.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_test_sender.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_test_sender.tcl -notrace
