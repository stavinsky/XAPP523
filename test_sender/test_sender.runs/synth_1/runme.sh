...
HD_PWD='/home/dev/dev/fpga/projects/manchester/test_sender/test_sender.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_test_sender.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_test_sender.tcl
